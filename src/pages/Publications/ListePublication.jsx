...
console.log("boutique", location)
  ...
  const deletePublication = async (id) => {
    await axios.delete(`http://localhost:3000/api/publication/${id}`);
    setPublications((prevPublication) =>
      prevPublication.filter((publication) => publication._id !== id),
    );
  };
  useEffect(() => {
        ...
        <div className="flex flex-col">
          ...
          {Publications.map((publication, key) => (
            ...
            >
              ...
              <div className="flex items-center justify-center p-2.5 xl:p-5">
                <p className="text-black dark:text-white">{publication.prix}</p>
              </div>

              <div className="hidden items-center justify-center p-2.5 sm:flex xl:p-5">
                <p className="text-black dark:text-white">{publication.type}</p>
              </div>
              <div className="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
                <div className="flex items-center space-x-3.5">
                  ...
                  <button
                    className="hover:text-primary"
                    onClick={() =>
                      navigate('/updatePublication', { state: publication })
                    }
                  >
                    <svg
                      className="fill-current"
